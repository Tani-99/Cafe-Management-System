...
public class ProductDao {
    ...
    public static void save(Product product){
        ...
        DbOperations.setDataOrDelete(query, "Product Added Succeccfully");
    }
    ...
    public static void delete(String id){
        ...
        DbOperations.setDataOrDelete(query, "Product Deleted Succeccfully");
    }
    ...
    public static ArrayList<Product> getAllRecordsByCategory(String category){
        ...
        public static ArrayList<Product> fliterProductByname(String name,String category){
        ArrayList<Product> arrayList = new ArrayList<>();
        try{
